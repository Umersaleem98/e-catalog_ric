                    ...
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="templates/images/event_1.jpg" alt="https://unsplash.com/@theunsteady5">
                            </div>
                        </div>
            ...
            <div class="row event_item">
                <div class="col">
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="templates/images/event_2.jpg" alt="https://unsplash.com/@claybanks1989">
                            </div>
                        </div>
            ...
            <div class="row event_item">
                <div class="col">
                    <div class="row d-flex flex-row align-items-end">
                        ...
                        <div class="col-lg-4 order-lg-3 order-1">
                            <div class="event_image">
                                <img src="templates/images/event_3.jpg" alt="https://unsplash.com/@juanmramosjr">
                            </div>
                        </div>
